int npnPin = 7;    //pin Arduino yang connect dengan NPN Transistor
const int buzzPin = 8;   //pin Arduino yang connect dengan buzzer
...
void loop()
{
  tone(buzzPin, 523, 500);  // memutar nada (f = 523 Hz, t = 500 ms)
